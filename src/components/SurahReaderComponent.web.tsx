...
export default function SurahReaderComponent() {
  ...
  const renderPageContent = (page: any[], pageIndex: number) => (
    <ScrollView
      ...
      <View style={styles.page}>
        ...
        {pageIndex === 0 && (
          <View style={styles.surahCard}>
            ...
            <Text style={styles.translation}>{surah.name_translation}</Text>
            <Text style={styles.meta}>
              {surah.revelation_place.toUpperCase()} • {surah.verses_count} Ayat
            </Text>
          </View>
        )}
          ...
          <View>
            {page.map((verse: any) => (
              <View key={verse.ayah} style={styles.translationVerse}>
                ...
                <Text style={styles.translationAyahNumber}>{verse.ayah}</Text>
              </View>
            ))}
          </View>
        )}
  ...
  return (
    <SafeAreaView style={styles.container} edges={["left", "right", "top"]}>
      <View style={styles.root}>
        ...
        {/* FIXED MODE SWITCHER BAR */}
        <View style={styles.fixedModeBar}>
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      active && styles.activeTextModeButton,
                    ]}
                  >
                    <Text
                      style={[
                        styles.textModeText,
                        active && styles.activeTextModeText,
                      ]}
                    >
                      {mode === "arabic"
                        ? "Arabic"
        ...
        <View style={styles.pagerContainer}>
          {renderPageContent(pages[currentPageIndex], currentPageIndex)}
        </View>
        ...
        {pages.length > 1 && (
          <View style={styles.pageControls}>
            <TouchableOpacity
              style={[
                styles.pageButton,
                currentPageIndex === pages.length - 1 && styles.disabledButton,
              ]}
